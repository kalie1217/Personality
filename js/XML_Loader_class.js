...
function load_XML (URX) {
  ...
  function checkBrowser () {
      ...
      browser.name = 'safari'
      if (navigator.userAgent.match('rv:1\.9')) { browser.firefox3 = true }
...
function tagNameElementSafari (rootElem, tagName) {
    ...
    if (rootElem.childNodes[w].nodeName == tagName) { R.push(rootElem.childNodes[w]) }
  }
